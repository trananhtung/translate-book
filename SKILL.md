---
name: translate-book
description: Translate books into any language using parallel sub-agents and generate a beautiful print-quality PDF. Converts input -> Markdown chunks -> translated chunks -> HTML -> PDF (6×9 inch, professional typography).
